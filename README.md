...
_На вопрос "Зачем это ?", отвечу, что это просто хобби, к тому же давно думал, куда бы применить этот кирпич в виде ATmega16 DIP-40, а необычное управление в виде ИК датчика мне показалось очень не обычным на практике, мне это понравилось, хоть и обычная кнопка будет немного удобнее._
